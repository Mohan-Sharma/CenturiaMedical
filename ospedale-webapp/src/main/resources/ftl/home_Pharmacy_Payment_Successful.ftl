                    ...
                    <table width="600" border="0" cellpadding="5" align="center">
                        <tr>
                            <td>
                                ...
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px;">Respected ${patientName}, ${afyaId}</p>
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;">
                                    An amount of ${amount} has been paid by ${patientName} against Order Number ${orderNo}. Please initiate dispatch of medicines.
                                </p>
