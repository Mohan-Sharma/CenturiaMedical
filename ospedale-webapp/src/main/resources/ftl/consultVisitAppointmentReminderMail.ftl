                    ...
                    <table width="600" border="0" cellpadding="5" align="center">
                        <tr>
                            <td>
                                ...
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px;">Respected ${firstName} ${lastName}, ${afyaId}<br/><br/>
                               This is to remind you for your appointment at ${clinicName} with ${doctorName} scheduled on ${date} , ${time} . Please reach on time. 
                               </p>
                                ...
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> ${providerName} </p>
								<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> ${clinicName} </p>
								<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> ${clinicAddress} </p>
								<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> ${clinicContact} </p>
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> This email is sent on behalf of ${clinicName} <br /> </p>
                                </td>
                        </tr>
                    </table>		   </td>
            </tr>
