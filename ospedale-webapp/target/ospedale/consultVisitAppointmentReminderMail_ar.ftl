                    ...
                    <table width="600" border="0" cellpadding="5" align="center">
                        <tr>
                            <td>
                                ...
                                <p dir="rtl" lang="ar" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px;">  المحترم ${firstName} ${lastName},${afyaId}<br/><br/>
                                الآتي لتذكيرك بأن موعدك في ${clinicName} مع ${doctorName} قد تمت جدولته في ${date} ، ${time} . يرجى الوصول في الوقت المحدد.
                               </p>
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;">&nbsp;</p>
                                <p dir="rtl" lang="ar" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> تفضلوا وافر التحية، </p>
								<p dir="rtl" lang="ar" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> ${providerName} </p>
								<p dir="rtl" lang="ar" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> ${clinicName} </p>
								<p dir="rtl" lang="ar" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> ${clinicAddress} </p>
								<p dir="rtl" lang="ar" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> ${clinicContact} </p>
								<p dir="rtl" lang="ar" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> تم إرسال هذا البريد الإلكتروني نيابة عن ${clinicName} </p>
