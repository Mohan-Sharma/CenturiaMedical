                    ...
                    <table width="600" border="0" cellpadding="5" align="center">
                        <tr>
                            <td>
                                ...
                                موعدك في ${clinicName} مع ${doctorName} تم تأكيده في ${date} على ${time}
                               </p>
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;">&nbsp;</p>
                                <p dir="rtl" lang="ar" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> مع تحياتنا، </p>
								...
								<p dir="rtl" lang="ar" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> تم إرسال هذا البريد الإلكتروني نيابة عن ${clinicContact} </p>
