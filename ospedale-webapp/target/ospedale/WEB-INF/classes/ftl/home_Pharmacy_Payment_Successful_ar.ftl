                    ...
                    <table width="600" border="0" cellpadding="5" align="center">
                        <tr>
                            <td>
                                ...
                                <p dir="rtl" lang="ar" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px;"> المحترم ${patientName}, ${afyaId}<br/><br/>
                                تم دفع مبلغ وقدره ${amount} من قبل ${patientName} مقابل رقم الطلب ${orderNo} ، يرجى بدء إرسال الأدوية
                               </p>
