                    ...
                    <table width="600" border="0" cellpadding="5" align="center">
                        <tr>
                            <td>
                                ...
                                <p dir="rtl" lang="ar" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px;"> المحترم ${afyaId} ${firstName} ${lastName},<br/><br/>
                               تم استلام المبلغ المدفوع وقدره ${collectedAmount} وأكد موعد للزيارة المنزلية، تم إرسال إيصال الدفع إلى البريد الإلكتروني المسجل
يرجى إيجاد الإيصال المرفق للمراجعة
                               </p>
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;">&nbsp;</p>
                                <p dir="rtl" lang="ar" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> مع أطيب التحيات </p>
                                <p dir="rtl" lang="ar" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> <strong> عافية للرعاية المجتمعية. </strong><br /> </p>
                                </td>
                        </tr>
                    </table>		   </td>
            </tr>
