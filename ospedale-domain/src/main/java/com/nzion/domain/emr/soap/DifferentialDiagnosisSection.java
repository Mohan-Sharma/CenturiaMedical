...
@Entity
@DiscriminatorValue("DIFFERENTIAL_DIAGNOSIS")
@Cache(usage = CacheConcurrencyStrategy.TRANSACTIONAL, region = "com.nzion.domain")
public class DifferentialDiagnosisSection extends SoapSection{
	
	private Set<PatientIcd> icds;

	private Set<PatientCpt> cpts;	

	@OneToMany(targetEntity = PatientIcd.class, mappedBy = "differentialDiagnosisSection",orphanRemoval=true)
	...
	@OneToMany(targetEntity = PatientCpt.class, mappedBy = "differentialDiagnosisSection",orphanRemoval=true)
	@Cascade(value=CascadeType.ALL)
	...
	patientIcd.setDifferentialDiagnosisSection(this);
	...
	patientCpt.setDifferentialDiagnosisSection(this);
	boolean exist = false;
