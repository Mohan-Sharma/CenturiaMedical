...
public class Roles {
	...
	public static final long PROVIDER = 			0x0080000000000000l; // 36028797018963968
	public static final long ADMIN = 				0x0008000000000000l; // 2251799813685248
	...
	public static final long RECEPTION = 			0x0000000800000000l; // 34359738368
	public static final long BILLING = 				0x0000000080000000l; // 2147483648
	...
	public static final long CENTURIA_RECEPTION = 	0x0000000000800000l; // 8388608
	...
	public static final long[] PRACTICE_DEPENDENT_ROLES = 
		new long[]{ADMIN, PROVIDER, MEDICAL_ASSISTANT, PATIENT, NURSE, BILLING, CASE_MANAGER, CENTURIA_RECEPTION, RECEPTION, TECHNICIAN, STORE_MANAGEMENT,HOUSE_KEEPING,ORDER_MANAGEMENT};
	...
	static {
		...
		ROLENAMEANDVALUEMAP.put("CENTURIA_RECEPTION", CENTURIA_RECEPTION);
		...
		ROLEVALUEANDNAMEMAP.put(CENTURIA_RECEPTION , "CENTURIA_RECEPTION");
	...
	System.out.println("ORDER_MANAGEMENT "+ORDER_MANAGEMENT);
	}
}